...
theme = {}
theme.confdir = awful.util.getdir("config") .. "/themes/steeve"
...
theme.wallpaper_cmd = { "awsetbg -f .config/awesome/themes/steeve/background.jpg" }
...
theme.awesome_icon = theme.confdir .. "/icon.png"
...
-- Widget icons
theme.widget_sep = theme.confdir .. "/widgets/separator.png"
...
theme.widget_wifi = theme.confdir .. "/widgets/wifi.png"
